...
`execspansql` is a Go CLI for Spanner query execution (`execspansql`). It supports SQL parameter loading, multiple output formats (JSON/YAML/CSV), optional JQ filtering, and tracing options.
